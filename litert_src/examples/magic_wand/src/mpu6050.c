...
/* Application Data
  ...
  Remarks:
    This structure should be initialized by the MPU6050_Initialize function.
...
/*******************************************************************************
  ...
  Remarks:
    See prototype in mpu6050.h.
 */

void MPU6050_Initialize ( void )
{
    /* Place the App state machine in its initial state. */
    mpu6050Data.state = MPU6050_STATE_INIT;
...
void MPU6050_Tasks ( void )
{
    ...
    switch ( mpu6050Data.state )
    {
        ...
        case MPU6050_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                mpu6050_basic_init(MPU6050_ADDRESS_AD0_LOW>>1);

                mpu6050Data.state = MPU6050_STATE_SERVICE_TASKS;
            }
            break;
        }

        case MPU6050_STATE_SERVICE_TASKS:
        {
            float accel[3];
            float gyro[3];
